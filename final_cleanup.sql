-- =====================================================
-- SCRIPT FINAL - SIN ELIMINAR FK INEXISTENTES
-- =====================================================
-- Este script no intenta eliminar FK que no existen
...
-- =====================================================
-- PASO 8: CREAR FOREIGN KEYS (SIN ELIMINAR LAS EXISTENTES)
-- =====================================================
-- Intentar agregar FK a usuarios (ignorar si ya existe)
ALTER TABLE `usuarios` 
ADD CONSTRAINT `fk_usuario_rol` 
FOREIGN KEY (`rol_id`) REFERENCES `roles`(`id`) ON DELETE RESTRICT;

-- Intentar agregar FK a solicitudes_becas (ignorar si ya existe)
ALTER TABLE `solicitudes_becas` 
ADD CONSTRAINT `fk_solicitud_usuario` 
FOREIGN KEY (`estudiante_id`) REFERENCES `usuarios`(`id`) ON DELETE CASCADE;

-- Intentar agregar FK a documentos_solicitud (ignorar si ya existe)
...
-- Intentar agregar FK a notificaciones (ignorar si ya existen)
...
-- Intentar agregar FK a historial_academico (ignorar si ya existe)
